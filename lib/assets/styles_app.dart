...
class StyleApp {
  static ThemeData lightTheme(BuildContext context) {
    ...
    return theme.copyWith(
        colorScheme: Theme.of(context)
            .colorScheme
            .copyWith(primary: Color.fromARGB(210, 43, 141, 73)));
  }
  ...
  static IconThemeData darkIcon(BuildContext context) {
    ...
    return icon.copyWith(color: Color.fromARGB(255, 86, 164, 210));
  }

  static IconThemeData lightIcon(BuildContext context) {
    final icon = IconThemeData.fallback();
    return icon.copyWith(color: Color.fromARGB(230, 11, 80, 32));
  }
